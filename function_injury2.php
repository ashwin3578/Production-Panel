...
function general_view_report($db){
    ...
    echo'<div class="row ">';
        ...
        echo'<div class="col-md-9 col-lg-9 report-box">';
        if(!empty($_POST['injuryreport_number'])){
           // show_report_injury($db,$_POST['injuryreport_number']);
        }
        
        echo'</div>';
        echo'<div class="col-sm-3 dialog-box" >';
        //dialog_box($db);
        if(empty($_POST)){
            ajax_load(array(),'injury-ajax.php','dialog-box');
        }
...
function view_all_report($db){
    ...
    foreach(get_all_injury_report($db) as $injuryreport){
        ...
        echo'<div class="row report_list">';
            echo'<div class="col-sm-8">';
                echo'<div class="btn btn-primary injury_button" onClick="thenumber=\''.$injuryreport['injuryreport_number'].'\';show_injury();show_menu();">';
    ...
    echo'<div class="row main-box report">';
        ...
        echo'<br><div class="row">';
            ...
            echo'<div class="col-md-12 col-lg-12">';
                if(!empty($entry['injuryreport_name'])){writeline('Name of injured/ill person',$entry['injuryreport_name']);}
        ...
        echo'<br><div class="row">';
            ...
            echo'<div class="col-md-12 col-lg-12">';
                ...
                echo'" >
                    ...
                    <div class="col-sm-6 col-lg-3">Does WorkSafe (WHSQ) &amp;/or the Electrical Safety Office (ESO) need to be notified?</div>
            ...
            echo'" id="injuryreport_worksafeREF-input" ';
                ...
                echo'>
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">WorkSafe/ESO reference number</div>
                    <div class="col-sm-6 col-lg-3">
            ...
            echo'" id="injuryreport_worksafe_receipt-input" ';
                ...
                echo'>
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">Notification receipt from WorkSafe/ESO</div>
                    <div class="col-sm-6 col-lg-3">
    ...
    echo'<div class="row main-box followup" style="min-height:100px">';
        ...
        echo'<br><div class="row">';
            ...
            echo'<div class="col-md-12 col-lg-12">';
                ...
                echo'" >
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">Does WorkCover need to be notified?</div>
                    <div class="col-sm-6 col-lg-3">';
            ...
            echo'" id="injuryreport_workcoverREF-input" ';
                ...
                echo'>
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">WorkCover reference number</div>
                    <div class="col-sm-6 col-lg-3">
            ...
            echo'" id="injuryreport_workcover_date_accepted-input" ';
                ...
                echo'>
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">Date claim was accepted by WorkCover</div>
                    <div class="col-sm-6 col-lg-3">
                ...
                echo'" >
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">What is the injury/illness category for this report?</div>
                    <div class="col-sm-6 col-lg-3">';
                ...
                echo'" >
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">Is this a lost time injury (LTI)?</div>
                    <div class="col-sm-6 col-lg-3">';
                ...
                echo'>
                    <div class="col-lg-3 "><br></div>
                    <div class="col-sm-6 col-lg-3">Total lost time hours</div>
                    <div class="col-sm-6 col-lg-3">
...
function editline($title,$content,$option1='',$option2='',$option3='',$placeholder='',$noOnClick=''){
    ...
    ajax_button('empty_dialog',[['injuryreport_number','thenumber'],['dialog',"'edit'"]],'injury-ajax.php','dialog-box');  
        echo'<div class="col-lg-3 "><br></div>';
        echo'<div class="col-sm-6 col-lg-3">'.$title.'</div>';
...
function writeline($title,$content,$option1=''){
    ...
    if($option1=='tobehidden' and empty($_SESSION['temp']['role_injury_viewall'])){
        ...
        echo'<div class="row line-report ">';//'.$option1.'
            echo'<div class="col-lg-3 "><br></div>';
            echo'<div class="col-sm-6 col-lg-3 ">'.$title.'</div>';
            echo'<div class="col-sm-6 col-lg-3 ">'.$content.'</div>';
        echo'</div>';
    }
}
