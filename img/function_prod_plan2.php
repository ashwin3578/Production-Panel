...
function main_view($db){
    if(!empty($_POST['summary-view'])){
		show_summary($db);
	}elseif(!empty($_POST['check-stock'])){
...
function navbar_prodplan($db){
	...
	echo'<div class="row">';
        ...
        if(empty($_POST['summary-view'])and empty($_POST['check-stock'])){
            ...
            echo'<div class="col-sm-1 " >';
                ...
                echo'<button type="submit" name="check-stock" value="view"  class="btn btn-default" >Check Stock</button>';
            ...
            echo'<div class="col-sm-4 " >';
                ...
                echo'>';
                    ...
                    if(($remaining)>$allstock[$order['Location']][$order['Code']]['Maximum']){
                        ...
                        $warning=0;
                        foreach($allstock[$order['Location']][$order['Code']]['List'] as $component){
                            if($remaining>$allstock[$order['Location']][$order['Code']][$component]['Equivalent']){
                                if(empty($allstock[$order['Location']][$order['Code']][$component]['HasSub'])){
                                    $warning=1;
                                    echo'<img class="" src="img/warning.png" width="50"> ';
                                }
                            }
                        }
                        if (empty($warning)){
                            echo'<img class="" src="img/warning.png" width="25"> ';
                        }
