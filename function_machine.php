    ...
    echo'<div class="row ">';
        ...
        echo'<div  class="'.$defaultcol.'">';
            ...
            echo'<div id="here">';
                ...
                }elseif($_POST['view']=='All Last'){
                
                    ArduinoMangerController::show_main();
...
function navbar_machine($db){
    ...
    echo'<div class="row navbar navbar_injury">';
       ...
       // }
        ...
        echo'<input type="submit" name="view" value="All Last"  class="btn btn-primary injury_button" onclick="submit();" >';
        echo'</div>';
        echo'<div class="col-sm-1 ">';
        //if($_SESSION['temp']['id']=='CorentinHillion'){
