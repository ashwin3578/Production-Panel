            ...
            foreach($allinfoproduct as &$infoproduct){
                echo'<div class="row">';
                    echo'<div class="col-sm-9">';
                        ...
                        if(!empty($infoproduct['document_filename'])){
                            echo'<a target="blank"  href="/ressource_v2/MD&S/'.$infoproduct['document_filename'].'">';
                         }
                        ...
                        echo '</button>';
                        // echo"</small>";
                        if(!empty($infoproduct['document_filename'])){echo'</a>';}
                    echo'</div>';
...
function get_product_asset($db,$asset_id){
    ...
    left join doc_link on doclink_productcode=assetproduct_productcode
    ...
    WHERE assetproduct_assetid='$asset_id'  and doclink_doctype='MD&S' ";
    ...
    if ( $_POST['type']=='detail' or $_POST['type']=='move' or $_POST['type']=='save' or $_POST['type']=='add_location' or $_POST['type']=='add_asset' or $_POST['type']=='edit'){
        echo'<div class="row">';
            ...
            echo'<div class="col-lg-2 col-sm-2">';
                if(!empty($_POST['last_page'])){$action='action="'.$_POST['last_page'].'"';}
                ...
                echo'<br><button type="submit" name="type" value="'.$value.'"  class="btn btn-default" >
                                    <span class="glyphicon glyphicon-step-backward" > </span>'.$caption.'
                </button><br>&nbsp';
